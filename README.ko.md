...
TTS 무음 제거는 생성된 음성 파일의 앞뒤 무음만 제거하고, 내레이션 중간의 의도된 공백은 유지합니다.
...
- 릴리스 ZIP: `release/Slide-Cut-v1.1.2-macos-arm64.zip`
- SHA256 체크섬: `release/Slide-Cut-v1.1.2-macos-arm64.zip.sha256`
