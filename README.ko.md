...
- 편집 화면과 자주 쓰는 작업 흐름을 더 자연스럽게 다듬기
...
내레이션 영상을 만들려면 Settings에서 API Key를 입력합니다.
...
Slide Cut은 MIT License로 배포됩니다. 자세한 내용은 [LICENSE](LICENSE)를 확인하세요.

포함된 오픈소스 패키지와 자산 고지는 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)에 정리되어 있습니다.
