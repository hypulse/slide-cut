export function createProjectModel(deps) {
  ...
  function serializeCurrentSlide() {
    ...
    setSlideAtIndex(activeSlideIndex, {
      ...
      noteSegments: normalizeNoteSegments(slides[activeSlideIndex]?.noteSegments, slideNotes.value),
  ...
  function normalizeProjectData(data) {
    ...
    const normalizedSlides = data.slides.map((slide, index) => ({
      ...
      noteSegments: normalizeNoteSegments(slide.noteSegments, typeof slide.notes === "string" ? slide.notes : ""),
